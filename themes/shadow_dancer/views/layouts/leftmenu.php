...
?>
            ...
            <li <?php if($controller=='page'||$controller=='executive' || $controller=='structure' || $controller=='board'){?> class="current" <?php }?>><a href="#">เกี่ยวกับหน่วยงาน</a>
                <ul <?php if($controller=='page'||$controller=='executive' || $controller=='structure' || $controller=='board'){?>style="display:  "<?php }else{?>style="display: none"<?php }?>>
