...
<h1>เรียงลำดับการแสดงผล ประเภทบุคลากร</h1>
...
<script>
        var baseUrl = "<?php echo Yii::app()->createUrl('personnelType'); ?>"
</script>
<div class="form">
...
<?php
    ...
    $items = CHtml::listData($dataProvider->getData(), 'personnel_type_id', 'name_th');
...
?>&nbsp;&nbsp;
<?php echo CHtml::Button('ยกเลิก', array('onClick'=>'window.location="'.Yii::app()->createUrl('personnelType').'"')); ?>
</div>
</div>
