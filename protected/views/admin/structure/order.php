...
<script>
        var baseUrl = "<?php echo Yii::app()->createUrl('structure'); ?>"
</script>
<div class="form">
...
<?php
    ...
    $items = CHtml::listData($dataProvider->getData(), 'str_id', 'name_th');
...
?>&nbsp;&nbsp;
<?php echo CHtml::Button('ยกเลิก', array('onClick'=>'window.location="'.Yii::app()->createUrl('structure').'"')); ?>
</div>
</div>
