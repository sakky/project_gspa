...
?>
<h1>เรียงลำดับการแสดงผลข้อมูลหน่วยงานภายใน</h1>
...
<script>
        var baseUrl = "<?php echo Yii::app()->createUrl('organization'); ?>"
</script>
<div class="form">
...
<?php
    ...
    $items = CHtml::listData($dataProvider->getData(), 'org_id', 'name_th');
...
?>&nbsp;&nbsp;
<?php echo CHtml::Button('ยกเลิก', array('onClick'=>'window.location="'.Yii::app()->createUrl('organization').'"')); ?>
</div>
</div>
