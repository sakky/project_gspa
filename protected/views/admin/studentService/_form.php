...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model,'กรุณากรอกข้อมูลให้ถูกต้อง');?>
		...
		<?php echo $form->error($model,'ser_group'); ?>
	</div>
		...
		<?php echo $form->labelEx($model,'ser_type_id'); ?>
                <?php echo $form->dropDownList($model,'ser_type_id',$ser_type_list,array(
                            ...
                            'value' => '0',)); ?>
		<?php echo $form->error($model,'ser_type_id'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'pdf_en'); ?><br/>
                <?php if(!$model->isNewRecord) {echo $model->pdf_en." "; if($model->pdf_en) {echo cHtml::link('view', '../../uploads/student_services/'.$model->pdf_en);} }?><br />
	...
	<div class="row">
		...
		<?php if(!$model->isNewRecord) {echo $model->pdf_th." "; if($model->pdf_th) {echo cHtml::link('view', '../../uploads/student_services/'.$model->pdf_th);} }?><br />
