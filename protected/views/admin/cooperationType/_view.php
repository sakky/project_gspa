...
/* @var $data CooperationType */
?>

<div class="view">

	<b><?php echo CHtml::encode($data->getAttributeLabel('co_type_id')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->co_type_id), array('view', 'id'=>$data->co_type_id)); ?>
	<br />
