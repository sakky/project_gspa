...
<h1>เรียงลำดับการแสดงผลประเภทความร่วมมือทางวิชาการ</h1>
...
<script>
        var baseUrl = "<?php echo Yii::app()->createUrl('cooperationType'); ?>"
</script>
<div class="form">
...
<?php
    ...
    $items = CHtml::listData($dataProvider->getData(), 'co_type_id', 'name_th');
...
?>&nbsp;&nbsp;
<?php echo CHtml::Button('ยกเลิก', array('onClick'=>'window.location="'.Yii::app()->createUrl('cooperationType').'"')); ?>
</div>
</div>
