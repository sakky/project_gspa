...
?>
<h1>เรียงลำดับประเภทหลัก ประชาสัมพันธ์/กิจกรรม</h1>
...
<script>
        var baseUrl = "<?php echo Yii::app()->createUrl('newsType'); ?>"
</script>
<div class="form">
...
<?php
    ...
    $items = CHtml::listData($dataProvider->getData(), 'news_type_id', 'name_th');
...
?>&nbsp;&nbsp;
<?php echo CHtml::Button('ยกเลิก', array('onClick'=>'window.location="'.Yii::app()->createUrl('newsType').'"')); ?>
</div>
</div>
