...
<h1>เรียงลำดับการแสดงผลข้อมูลประเภทรายงาน</h1>
...
<script>
        var baseUrl = "<?php echo Yii::app()->createUrl('reportType'); ?>"
</script>
<div class="form">
...
<?php
    ...
    $items = CHtml::listData($dataProvider->getData(), 'report_type_id', 'name_th');
...
?>&nbsp;&nbsp;
<?php echo CHtml::Button('ยกเลิก', array('onClick'=>'window.location="'.Yii::app()->createUrl('reportType').'"')); ?>
</div>
</div>
