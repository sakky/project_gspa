...
?>
<h1>เรียงลำดับการแสดงผลประเภทคลังข้อมูลความรู้</h1>
...
<script>
        var baseUrl = "<?php echo Yii::app()->createUrl('knowledgeType'); ?>"
</script>
<div class="form">
...
<?php
    ...
    $items = CHtml::listData($dataProvider->getData(), 'know_type_id', 'name_th');
...
?>&nbsp;&nbsp;
<?php echo CHtml::Button('ยกเลิก', array('onClick'=>'window.location="'.Yii::app()->createUrl('knowledgeType').'"')); ?>
</div>
</div>
