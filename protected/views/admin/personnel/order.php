...
<script>
        var baseUrl = "<?php echo Yii::app()->createUrl('personnel'); ?>"
</script>
...
<?php
    ...
    $items = CHtml::listData($dataProvider->getData(), 'personnel_id', 'name_th');
...
?>&nbsp;&nbsp;
<?php echo CHtml::Button('ยกเลิก', array('onClick'=>'window.location="'.Yii::app()->createUrl('personnel').'"')); ?>
</div>
</div>
