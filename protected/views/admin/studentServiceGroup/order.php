...
?>
<h1>เรียงลำดับการแสดงผลประเภทหลักบริการนิสิต</h1>
...
<script>
        var baseUrl = "<?php echo Yii::app()->createUrl('studentServiceGroup'); ?>"
</script>
<div class="form">
...
<?php
    ...
    $items = CHtml::listData($dataProvider->getData(), 'ser_group', 'ser_name');
...
?>&nbsp;&nbsp;
<?php echo CHtml::Button('ยกเลิก', array('onClick'=>'window.location="'.Yii::app()->createUrl('studentServiceGroup').'"')); ?>
</div>
</div>
