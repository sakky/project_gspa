...
<h1>เรียงลำดับการแสดงผล Link ที่เกี่ยวข้อง</h1>
...
<script>
        var baseUrl = "<?php echo Yii::app()->createUrl('link'); ?>"
</script>
<div class="form">
...
?>&nbsp;&nbsp;
<?php echo CHtml::Button('ยกเลิก', array('onClick'=>'window.location="'.Yii::app()->createUrl('link').'"')); ?>
</div>
</div>
