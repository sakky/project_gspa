...
<script>
        var baseUrl = "<?php echo Yii::app()->createUrl('documentType'); ?>"
</script>
<div class="form">
...
<?php
    ...
    $items = CHtml::listData($dataProvider->getData(), 'doc_type_id', 'name_th');
...
?>&nbsp;&nbsp;
<?php echo CHtml::Button('ยกเลิก', array('onClick'=>'window.location="'.Yii::app()->createUrl('documentType').'"')); ?>
</div>
</div>
