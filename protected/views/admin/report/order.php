...
<h1>เรียงลำดับการแสดงผลข้อมูลรายงาน</h1>
...
<script>
        var baseUrl = "<?php echo Yii::app()->createUrl('report'); ?>"
</script>
<div class="form">
...
<?php
    ...
    $items = CHtml::listData($dataProvider->getData(), 'report_id', 'name_th');
...
?>&nbsp;&nbsp;
<?php echo CHtml::Button('ยกเลิก', array('onClick'=>'window.location="'.Yii::app()->createUrl('report').'"')); ?>
</div>
</div>
