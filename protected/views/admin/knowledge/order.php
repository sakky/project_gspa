...
<script>
        var baseUrl = "<?php echo Yii::app()->createUrl('knowledge'); ?>"
</script>
<div class="form">
...
<?php
    ...
    $items = CHtml::listData($dataProvider->getData(), 'know_id', 'name_th');
...
?>&nbsp;&nbsp;
<?php echo CHtml::Button('ยกเลิก', array('onClick'=>'window.location="'.Yii::app()->createUrl('knowledge').'"')); ?>
</div>
</div>
