...
<h1>เรียงลำดับการแสดงผล Slide</h1>
...
<script>
        var baseUrl = "<?php echo Yii::app()->createUrl('slide'); ?>"
</script>
<div class="form">
...
<?php
    ...
    $items = CHtml::listData($dataProvider->getData(), 'slide_id', 'title_th');
...
?>&nbsp;&nbsp;
<?php echo CHtml::Button('ยกเลิก', array('onClick'=>'window.location="'.Yii::app()->createUrl('slide').'"')); ?>
</div>
</div>
