...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('left_menu_id')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->left_menu_id), array('view', 'id'=>$data->left_menu_id)); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('page_type_id')); ?>:</b>
	<?php echo CHtml::encode($data->page_type_id); ?>
	<br />
