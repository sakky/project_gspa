...
<script>
        var baseUrl = "<?php echo Yii::app()->createUrl('cooperation'); ?>"
</script>
<div class="form">
...
<?php
    ...
    $items = CHtml::listData($dataProvider->getData(), 'co_id', 'name_th');
...
?>&nbsp;&nbsp;
<?php echo CHtml::Button('ยกเลิก', array('onClick'=>'window.location="'.Yii::app()->createUrl('cooperation').'"')); ?>
</div>
</div>
