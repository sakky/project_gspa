...
<ul class="list-1">
        ...
        ?>
        <li><a href="<?php echo Yii::app()->createUrl('cooperation', array('type_id'=>$type->co_type_id)); ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/front/marker_2.gif" border="0" style="padding-top: 7px"/>&nbsp;<?php echo $type->name_en;?></a></li>        
        <?php }?>
...
<ul class="list-1">
        <li><h6><a href="<?php echo Yii::app()->createUrl('cooperation/inbound'); ?>">ภายในประเทศ</a></h6></li>
         <?php
            ...
            foreach($co_type as $type) {
        ?>
        <li><a href="<?php echo Yii::app()->createUrl('cooperation', array('type_id'=>$type->co_type_id)); ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/front/marker_2.gif" border="0" style="padding-top: 7px"/>&nbsp;<?php echo $type->name_th;?></a></li>        
        <?php }?>
