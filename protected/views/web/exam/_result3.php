    ...
    <div class="answer_content form_3">
        ...
        <ul>
            ...
            <li>
                   ...
                   <input type="radio" id="ans<?php echo $i;?>_5" name="ans[<?php echo $i;?>]" value="จ" <?php if($test['selected']=='จ'){?>checked<?php }?> disabled/>
                   <label for="ans<?php echo $i;?>_5"
                   <?php if(($test['answer']==$test['selected'])&&($test['answer']=='จ')){?>
                         class="right"
                   <?php }else if(($test['answer']!=$test['selected'])&&($test['answer']=='จ')){?>
                        class="wrong"
                   <?php }?>
                          >จ</label>

                   <input type="radio" id="ans<?php echo $i;?>_6" name="ans[<?php echo $i;?>]" value="ฉ" <?php if($test['selected']=='ฉ'){?>checked<?php }?> disabled/>
                   <label for="ans<?php echo $i;?>_6"
                   <?php if(($test['answer']==$test['selected'])&&($test['answer']=='ฉ')){?>
                         class="right"
                   <?php }else if(($test['answer']!=$test['selected'])&&($test['answer']=='ฉ')){?>
                        class="wrong"
                   <?php }?>
                          >ฉ</label>
