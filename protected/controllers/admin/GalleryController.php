...
class GalleryController extends AdminController
{
	...
	public function init() {
		$this->upload_path = Yii::app()->basePath . '/../uploads/gallery/';
	}
	...
	public function actionCreate()
	{
		...
		{
                        $_POST['Gallery']['user_id'] = Yii::app()->user->id;
			$model->attributes=$_POST['Gallery'];
                        $image = CUploadedFile::getInstance($model, 'image');	
		
			if($image) {

				$genName = 'gallery_' . date('YmdHis');
				$saveName = $genName;
        ...
        */
        public function actionOrder()
        {
            ...
            if (isset($_POST['Order']))
            {
                ...
                {
                    if ($model = Gallery::model()->findbyPk($models[$i]))
                    {
                        $model->sort_order = $i;
            ...
            else
            {
                $dataProvider = new CActiveDataProvider('Gallery', array(
                    'pagination' => false,
                    'criteria' => array(
                        'order' => 'sort_order ASC, gallery_id DESC',
                    ),
                ));
