...
/**
 * This is the model class for table "gs_report_type".
 *
 * The followings are the available columns in table 'gs_report_type':
...
class ReportType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('report_type_id, name_en, name_th, sort_order, status', 'safe', 'on'=>'search'),
		);
	}
