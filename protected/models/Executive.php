...
/**
 * This is the model class for table "gs_executive".
 *
 * The followings are the available columns in table 'gs_executive':
 * @property integer $exec_id
 * @property integer $title_en
 * @property integer $title_th
 ...
 */
class Executive extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('exec_id,name_en, name_th, sex, position_en, position_th, image, sort_order, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('exec_id',$this->exec_id);
