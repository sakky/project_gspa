...
class Document extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('counter, sort_order, status, user_id', 'numerical', 'integerOnly'=>true),
			...
			array('doc_id, name_en, name_th, pdf_en, pdf_th, last_update, counter, sort_order, status, user_id, time_stamp', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'user' => array(self::BELONGS_TO, 'GsUser', 'user_id'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'doc_id' => 'รหัส',
			'name_en' => 'ชื่อเอกสาร (ภาษาอังกฤษ)',
			'name_th' => 'ชื่อเอกสาร (ภาษาไทย)',
